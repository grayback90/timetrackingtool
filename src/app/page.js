...
export default function Home() {
  return (
    <main className="flex min-h-min flex-col items-center justify-between pt-24 px-24">
      ...
      <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 pt-50 rounded">
        Save Entry
      </button>
      <section className="mt-10 container mx-auto p-6 font-mono">
                ...
                <tr className="text-gray-700">
                  <td className="px-4 py-3 border">
                    <div className="flex items-center text-sm">
                      <div>
                        <p className="font-semibold text-black">Support-13131</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-ms font-semibold border">75</td>
                  <td className="px-4 py-3 text-xs border">
                    <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> SFGroup </span>
                  </td>
                  <td className="px-4 py-3 text-sm border">30.08.2023</td>
                </tr>
                <tr className="text-gray-700">
                  <td className="px-4 py-3 border">
                    <div className="flex items-center text-sm">
                      <div>
                        <p className="font-semibold text-black">Support-12121</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-ms font-semibold border">60</td>
                  <td className="px-4 py-3 text-xs border">
                    <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> SFTech </span>
                  </td>
                  <td className="px-4 py-3 text-sm border">30.08.2023</td>
                </tr>
                <tr className="text-gray-700">
                  <td className="px-4 py-3 border">
                    <div className="flex items-center text-sm">
                      <div>
                        <p className="font-semibold text-black">Daily</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-ms font-semibold border">15</td>
                  <td className="px-4 py-3 text-xs border">
                    <span className="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-sm"> Meeting </span>
                  </td>
                  <td className="px-4 py-3 text-sm border">30.08.2023</td>
                </tr>
              </tbody>
